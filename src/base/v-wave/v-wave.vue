<template>
  <div>
    <svg viewBox="0 0 4000 100"  class="wave wave--back">
      <path :d="d3" fill-opacity="0.3"/>
    </svg>
    <svg viewBox="0 0 4000 100"  class="wave wave--middle">
      <path :d="d2"  fill-opacity="0.5"/>
    </svg>
    <svg viewBox="0 0 4000 100"  class="wave wave--front">
      <path :d="d1"/>
    </svg>
  </div>
</template>
...
.wave--front {
  ...
  animation: move 4.5s cubic-bezier(0.68,0.35,0.37,0.65) infinite;
}
  
.wave--middle {
  animation: move 3.5s cubic-bezier(0.68,0.35,0.37,0.65) infinite;
}

.wave--back {
  animation: move 3s cubic-bezier(0.68,0.35,0.37,0.65) infinite;
}
